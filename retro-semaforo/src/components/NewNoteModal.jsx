      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all scale-100">
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              type="text"
              className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-slate-900 focus:ring-2 focus:ring-indigo-500 outline-none"
          ...
          <div>
            ...
            <textarea
              className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-slate-900 focus:ring-2 focus:ring-indigo-500 outline-none resize-none h-24"
